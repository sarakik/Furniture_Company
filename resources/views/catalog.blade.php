					...
					<div class="row justify-content-center">
						<div class="col-lg-10 active-hot-deal-carusel">
							...
							<div class="single-carusel">
								<div class="thumb relative">
									<div class="overlay overlay-bg"></div>
									<img class="img-fluid" src="img/packages/hot-deal2.jpg" alt="">
								</div>
								<div class="price-detials">
									<a href="#" class="price-btn">Starting From <span>$250</span></a>
								</div>
								<div class="details">
									<h4 class="text-white">Natural Landscape</h4>
									<p class="text-white">
							...
							<div class="single-carusel">
								<div class="thumb relative">
									<div class="overlay overlay-bg"></div>
									<img class="img-fluid" src="img/packages/hot-deal3.jpg" alt="">
								</div>
								<div class="price-detials">
									<a href="#" class="price-btn">Starting From <span>$250</span></a>
								</div>
					...
					<div class="row">
								...
								<div class="details">
									...
									<ul class="package-list">
										<li class="d-flex justify-content-between align-items-center">
											<span>Duration</span>
											<span>02 days and 3 nights</span>
										</li>
										<li class="d-flex justify-content-between align-items-center">
											<span>Date</span>
						...
						<div class="col-lg-4">
							<div class="single-destinations">
								...
								<div class="details">
									<h4>Singapore Beach, Malaysia</h4>
									<p>
										Malaysia
									</p>
									<ul class="package-list">
							...
							<div class="single-destinations">
								...
								<div class="details">
									...
									<ul class="package-list">
										<li class="d-flex justify-content-between align-items-center">
											<span>Duration</span>
											<span>04 days and 5 nights</span>
										</li>
										<li class="d-flex justify-content-between align-items-center">
											<span>Date</span>
							...
							<div class="single-destinations">
								...
								<div class="details">
									...
									<ul class="package-list">
										<li class="d-flex justify-content-between align-items-center">
											<span>Duration</span>
											<span>05 days and 6 nights</span>
										</li>
										<li class="d-flex justify-content-between align-items-center">
											<span>Date</span>
						...
						<div class="col-lg-4">
							<div class="single-destinations">
								...
								<div class="details">
									<h4>London Square Garden Area</h4>
									<p>
										United Kingdom
									</p>
									<ul class="package-list">
